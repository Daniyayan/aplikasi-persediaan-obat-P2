...
<html>
  <head>
    ...
    <meta name="author" content="dani ardika" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:30px">POT</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2022 - <a href="www.indrasatya.com">www.Daniardika19@gmail.com</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
