      ...
      <div class="col-lg-12 col-xs-12">
        <div class="alert alert-info alert-dismissable">
          ...
          <p style="font-size:15px">
            <i class="icon fa fa-user"></i> Selamat datang <strong><?php echo $_SESSION['username']; ?></strong> di Aplikasi Persediaan Obat.
          </p>        
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00c0ef;color:#fff" class="small-box">
          ...
          <?php  
          if ($_SESSION['hak_akses']!='Manajer'|| $_SESSION['hak_akses'] == 'Gudang') { ?>
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00a65a;color:#fff" class="small-box">
          ...
          <?php  
    if ($_SESSION['hak_akses'] == 'Gudang' || $_SESSION['hak_akses'] == 'Manajer') { ?>
...
?>
    ...
    <div style="background-color:#00a65a;color:#fff" class="small-box">
        <div class="inner">
            <?php   
            // Modify the query to SUM data from the "is_obat_keluar" table
        ...
        <div class="icon">
            <i class="fa fa-sign-out"></i> <!-- Change the icon to a suitable one for "Obat Keluar" -->
        </div>
        <?php  
    if ($_SESSION['hak_akses'] == 'Gudang' || $_SESSION['hak_akses'] == 'Manajer') { ?>
        <a href="?module=form_obat_masuk&form=add" class="small-box-footer" title="Tambah Data" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
